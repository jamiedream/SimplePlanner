        ...
        <div data-role="header">
            ...
            <div data-role="panel" id="topPanel" onmouseover="showMenu()" onmouseout="hideMenu()">
                <ul>
                    ...
                    <li>&nbsp&nbsp|&nbsp&nbsp</li>
                    <a href="" id="ha" onclick="tired()"><li>Stuff& Notify</li></a>
                    <li>&nbsp&nbsp|&nbsp&nbsp</li>
            ...
            <div id="sn">
                <div>
                    <fieldset data-role="controlgroup">
                        ...
                        <textarea name="stuff" id="stuff"><?= $rowPlan[13];?></textarea>
                    </fieldset>
                    <fieldset data-role="controlgroup">
                        <label for="note">Pay Attention For:</label>
                        <textarea name="note" id="note"><?= $rowPlan[14];?></textarea>
                    </fieldset>
                </div>
            </div>
            <div>
                <input type="submit" name="update3" id="update3" value="更新">
            </div>
        </div>
        </form>
